 ...
 * built; the two internal tools did not, which is backwards. A host who hits a
 * blank screen mid-way through pricing a season assumes their changes were
 * lost, and re-enters all of them.
 *
