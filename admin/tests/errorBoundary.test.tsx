 ...
 * backwards: an admin who hits a blank screen mid-moderation reports *the
 * platform* as down, and the on-call engineer starts by checking the API.
 *
...
describe('RouteErrorBoundary', () => {
  ...
  it('reports a permission failure as a refusal, not a fault', () => {
    ...
    // retryable — telling an admin "something went wrong" sends them to
    // engineering for something only an administrator can grant.
  ...
  it('shows the request id for a real fault', () => {
    // Support quoting this turns "the admin panel broke" into one log lookup.
